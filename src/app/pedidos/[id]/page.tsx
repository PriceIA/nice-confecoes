...
import { ArrowLeft, Printer, ChevronRight, CheckCircle2, Circle, Loader2, Pencil } from 'lucide-react'
                ...
                <div key={p.id} className="border border-gray-100 rounded-xl p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-3 gap-2 text-xs text-gray-500">
                    ...
                    {p.personalizacoes.length > 0 && (
                      <div className="col-span-2"><span className="font-medium text-gray-400">Person.:</span> {p.personalizacoes.join(', ')}</div>
                    )}
                  </div>
