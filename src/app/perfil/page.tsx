...
export default function PerfilPage() {
  ...
  return (
    <div className="max-w-md space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-nice-800">Meu perfil</h1>
        <p className="text-sm text-gray-500 mt-0.5">Seus dados de acesso</p>
      </div>
      ...
      <form onSubmit={trocarSenha} className="card space-y-4">
        <div className="flex items-center gap-2 text-nice-700">
